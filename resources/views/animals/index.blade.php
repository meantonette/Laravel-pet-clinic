...
<div class="py-3">
  ...
  @forelse ($animals as $animal)
      <tr>
        ...
        @else
        <td>
            <a href="#"><p class="text-center text-xl bg-blue-600 p-2">
                   Restore  &rarr;
               </p>
            </a>
        </td>
        ...
        <td>
            <a href="{{ route('animals.forceDelete', $animal->id) }}" >
                <p class="text-center text-xl bg-black text-white p-2 mx-2" onclick="return confirm('Do you want to delete this data permanently?')">
                   Destroy  &rarr;
                </p>
              </a>
          </td>
