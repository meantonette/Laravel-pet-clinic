...
<div>
        <div class="flex justify-center pt-4">
            <form action="/adopter/{{ $adopters->adopter_id }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="block">
                    <div>
                    ...
                    name="images">
                    <img src="{{ asset('uploads/adopters/'.$adopters->images)}}" alt="I am A Pic" width="100" height="100" class="ml-24 pb-2">
